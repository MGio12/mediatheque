...
<div class="page-header">
    <div class="container">
        ...
        <p>Complétez le formulaire pour ajouter un nouveau livre au catalogue.</p>
    </div>
</div>
...
<div class="container">
    <div class="content">
        ...
        <form method="POST" action="index.php?controller=livre&action=createPost">
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="isbn"
                    class="form-control"
                    value="<?= htmlspecialchars($_SESSION['old']['isbn'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    maxlength="13"
                    required
                >
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="editeur"
                    class="form-control"
                    value="<?= htmlspecialchars($_SESSION['old']['editeur'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    maxlength="255"
                    required
                >
            ...
            <div class="form-group">
                ...
                <input
                    ...
                    name="nombre_pages"
                    class="form-control"
                    value="<?= htmlspecialchars($_SESSION['old']['nombre_pages'] ?? '', ENT_QUOTES, 'UTF-8') ?>"
                    min="1"
                    max="10000"
                    required
                >
